...
*/
angular.module('smartq').controller('loginController', ['$scope', '$http', 'smartqService', 'loading', '$location', 'config', '$cordovaInAppBrowser', '$rootScope', 'alerta', 'msg', 'localStorageService', 'internet', '$ionicPopup', function($scope,$http,smartqService,loading,$location,config,$cordovaInAppBrowser,$rootScope,alerta,msg,localStorageService,internet,$ionicPopup){
