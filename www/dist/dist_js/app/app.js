...
.run(['$ionicPlatform', 'BackgroundGeolocationService', function($ionicPlatform,BackgroundGeolocationService) {
...
.config(['$stateProvider', '$urlRouterProvider', '$cordovaInAppBrowserProvider', function($stateProvider, $urlRouterProvider,$cordovaInAppBrowserProvider) {
